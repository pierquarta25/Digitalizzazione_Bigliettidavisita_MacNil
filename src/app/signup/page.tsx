...
export default function SignupPage() {
  ...
  const handleMicrosoftLogin = async () => {
    ...
    if (error) {
      setError(error.message || 'Impossibile accedere con Outlook. Riprova.')
      setLoading(false)
    }
  }
            ...
            <>
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white dark:bg-zinc-900 px-2 text-zinc-500">Oppure registrati con</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  type="button"
                  variant="outline"
                  className="py-6 text-sm font-semibold border-zinc-300 dark:border-zinc-850 text-zinc-700 dark:text-zinc-350 hover:bg-zinc-50 dark:hover:bg-zinc-800 flex items-center justify-center gap-2"
